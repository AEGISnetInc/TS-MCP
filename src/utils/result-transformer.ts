 ...
 */
function getScriptShortName(testScript: string): string {
 ...
 */
function extractFailuresFromScriptDetail(
  scriptDetail: ScriptExecDetailResponse,
  scriptName: string
): TestFailure[] {
 ...
 */
function extractTestItemsFromScriptDetail(
  scriptDetail: ScriptExecDetailResponse
): TestItemResult[] {
  const testItems = scriptDetail.testItemExecutions ?? [];
...
export function transformResults(
  execDetail: ExecutionDetailResponse,
  scriptDetails?: Map<string, ScriptExecDetailResponse>
): SummarizedTestResults {
